####################################SHORTCUTS###################################
lschm <-list.files(file.path(path_chm), pattern=".tif")
lssegm <- list.files(file.path(path_segm))
...
chm_2 <- raster(paste0(path_chm, lschm[[2]]))
crs(chm_2)
chm_3 <- raster(paste0(path_chm, lschm[[3]]))
crs(chm_3)
chm_4 <- raster(paste0(path_chm, lschm[[4]]))
crs(chm_4)
CHM <- raster(paste0(path_chm, lschm[[5]]))
crs(CHM)
