####################################SHORTCUTS###################################
lstrain <- list.files(file.path(path_analysis_results_train), pattern=".shp")
lstrain #"test.shp"    "train_1.shp" "train_2.shp"
lspredictor1 <- list.files(file.path(path_analysis_results_prdctr1), pattern=".tif")
...
lstraindat <- list.files(file.path(path_analysis_results_traindat), pattern=".csv")
lsFFS <- list.files(file.path(path_analysis_results_FFS), pattern = ".rds")
lsmod <- list.files(file.path(path_analysis_results_models), pattern = ".rds")
lspred <- list.files(file.path(path_analysis_results_predictions), pattern=".tif")
lssegm <- list.files(file.path(path_analysis_results_segm), pattern=".shp")
####################################LOAD DATA###################################
...
train_1 <-readOGR(file.path(path_analysis_results_train, lstrain[[2]]))
names(train_1)

train_2 <-readOGR(file.path(path_train, lstrain[[3]]))
...
#NAs detected: deleting 108354  NAs
write.csv(train1_pred1, file.path(path_analysis_results_traindat, "train1_pred1.csv"))
